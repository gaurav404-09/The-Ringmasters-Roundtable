...
export default function Galaxy({
  ...
  useEffect(() => {
    ...
    const resolution = new Float32Array([gl.canvas.width, gl.canvas.height, gl.canvas.width / gl.canvas.height]);
    const mouseUniform = new Float32Array([smoothMousePos.current.x, smoothMousePos.current.y]);
